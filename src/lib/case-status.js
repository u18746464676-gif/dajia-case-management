...
const STATUS_META = {
  ...
  not_accepted: { label: '不予受理', className: 'bg-sky-50 text-sky-700 border-sky-200', dotClass: 'bg-sky-500' },
  ...
  penalty: { label: '已处罚', className: 'bg-emerald-50 text-emerald-700 border-emerald-200', dotClass: 'bg-emerald-500' },
  punished: { label: '已处罚', className: 'bg-emerald-50 text-emerald-700 border-emerald-200', dotClass: 'bg-emerald-500' },
  ...
  not_filed: { label: '不予立案', className: 'bg-rose-50 text-rose-700 border-rose-200', dotClass: 'bg-rose-500' },
  ordered_correction: { label: '责令改正', className: 'bg-slate-100 text-slate-700 border-slate-200', dotClass: 'bg-slate-400' },
  not_punished: { label: '不予处罚', className: 'bg-slate-100 text-slate-700 border-slate-200', dotClass: 'bg-slate-400' },
  ...
  presumed_filed: { label: '推定立案期', className: 'bg-yellow-50 text-yellow-700 border-yellow-200', dotClass: 'bg-yellow-500' },
  abnormal: { label: '列入异常', className: 'bg-red-50 text-red-700 border-red-200', dotClass: 'bg-red-500' },
}
...
export function getCaseStatusMeta(caseOrStatus, profitValue) {
  ...
  const profit = typeof caseOrStatus === 'string' ? Number(profitValue || 0) : Number(caseOrStatus?.profit || caseOrStatus?.compensationAmount || 0)
